...
void CDH_DrawBitmapTransparent(int16_t x, int16_t y, const uint16_t* image, int16_t w, int16_t h, uint16_t transparentColor = 0xF81F, bool flipY = false, bool flipX = false);
